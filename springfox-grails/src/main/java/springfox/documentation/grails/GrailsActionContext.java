...
import static springfox.documentation.grails.Actions.actionsToHandler;
import static springfox.documentation.grails.Actions.mediaTypeOverrides;
import static springfox.documentation.grails.UrlMappings.resolvedPathParameters;
import static springfox.documentation.grails.UrlMappings.selector;
...
public class GrailsActionContext {
    ...
    public GrailsActionContext(GrailsControllerClass controller,
